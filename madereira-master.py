...
class SistemaOrcamentoMadeireira(QtWidgets.QMainWindow):
    ...
    def criar_interface_produtos(self):
        ...
        self.produto_vlr_m.setPlaceholderText("Valor Por Metro")  # New field for Value per Meter
    ...
    def validate_size_input(self):
        """Remove any non-numeric characters from the size input."""
    ...
    def adicionar_produto_orcamento(self):
        ...
        # Validate size input
        if not produto_tam.isdigit():
            QtWidgets.QMessageBox.warning(self, "Erro", "O tamanho deve conter apenas números!")
            return
